...
$items = Carrito::items();
?>
<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name='viewport' content='width=device-width,initial-scale=1'><title>Checkout</title>
  ...
  <?php else: ?>
    <table class="table">
      ...
      <?php $total=0; foreach($items as $id=>$qty):
         $p = Producto::find($id); if(!$p) continue;
